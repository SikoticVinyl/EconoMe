...
const transactionSchema = new mongoose.Schema({
  ...
  dueDate: {
    type: Date,
    required: true,
    required: function() { return this.transactionType === 'expense'; } // Only required for expenses
  },
  payDate: {
    type: Date,
    required: true,
    required: function() { return this.transactionType === 'income'; } // Only required for income
  },
  flexible: {
    type: Boolean,
